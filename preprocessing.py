...
class preprocessing:
    ...
    def get_contractions(self):
        contraction_dict = {"ain't": "is not", "aren't": "are not", "can't": "cannot", "'cause": "because",
                            ...
                            "you're": "you are", "you've": "you have", "nor": "not", "nt": "sio", "sio": "sio", "haiwezi": "haiwezi", "'sababu": "kwa sababu",
                            ...
                            "it've've": "itakuwa na", "ni": "ni", "hebu": "wacha sisi", "bibi": "madam",
                            "maynt": "may not", "might've": "may have", "may not": "inaweza isiwe",
                            "might't've": "might not have", "must've": "lazima have", "lazima": "lazima si",
                            "lazima usiwe": "lazima usiwe na", "hauitaji": "haitaji", "haifai": "haifai kuwa na",
                            "saa": "ya saa", "haipaswi": "haipaswi", "haipaswi": "haipaswi kuwa",
                            "haita": "haitafanya", "sha'n't": "haita", "hajapata": "hawatakuwa na",
                            "angeweza": "angekuwa", "angekuwa": "angekuwa na", "atakuwa": "atafanya",
                            "atakuwa": "atakuwa na", "yeye ni": "yuko", "anapaswa kuwa": "anapaswa kuwa",
                            "haipaswi": "haipaswi", "haipaswi kuwa": "haipaswi kuwa na", "so've": "vivyo hivyo",
                            "hivyo": "kwa hivyo", "hii ni": "hii ni", "hiyo": "hiyo ingekuwa",
                            "that'd've": "that would have", "that is": "that is", "there'd": "kungekuwa",
                            "kungekuwa": "kungekuwa na", "kuna": "kuna", "hapa": "hapa kuna",
                            "wangeweza": "wangeweza", "wangeweza": "wangekuwa", "watakuwa": "watakuwa",
                            "watakuwa na": "watakuwa na", "wao ni": "wao ni", "wana": "wana",
                            "kuwa na": "kuwa na", "haikuwa": "hakukuwa", "tungependa": "tungekuwa", "tungekuwa": "tungekuwa na",
                            "tuta": "tutafanya", "tutaweza": "tutakuwa na", "tuko": "sisi ni", "tumekuwa": "tuna",
                            "hawakuwa": "hawakuwa", "what'll": "what will", "what'll've": "nini kitakuwa na",
                            "ni nini": "ni nini", "ni nini": "ni nini", "ni nini": "nini", "ni lini": "ni lini",
                            "lini": "lini", "wapi": "wapi", "wapi": "wapi",
                            "wapi": "wapi", "nani": "nani", "nani atakuwa na": "nani atakuwa na",
                            "nani": "nani", "nani": "nani", "kwanini": "kwanini ni", "kwanini": "kwanini nimekuwa",
                            "will've": "will have", "won't": "will not", "won't've": "hatakuwa na",
                            "ingekuwa": "ingekuwa", "isingekuwa": "isingekuwa", "isingekuwa": "isingekuwa",
                            "y'all": "ninyi nyote", "y'all'd": "nyote mngefanya", "y'all'd": "nyote mngekuwa na",
                            "y'all're": "nyinyi nyote mko", "y'all've": "nyinyi nyote mna", "ningependa": "ungekuwa",
                            "ungekuwa": "ungekuwa", "utakuwa": "utafanya", "utakuwa": "utakuwa","wewe": "wewe ni",
                            "umepata": "unayo", "wala": "sio", "nt": "sio"}
    ...
    stopwords_verbs = ['ingekuwa', 'inaweza','say', 'get', 'go', 'know', 'may', 'need', 'make', 'see', 'want', 'come', 'take', 'use',
                       'would', 'can','na','lakini','ingawa','ingawaje','kwa','sababu','hadi','hata','kama','ambapo','ambamo',
                       'ambako','ambacho','ambao','ambaye','ilhali','ya','yake','yao','yangu','yetu','yenu','vya',
                       'vyao','vyake','vyangu','vyenu','vyetu','yako','yao','hizo','yenu','sisi','wewe','nyinyi','yeye',
                       'wao','nao','nasi','nanyi','ni','alikuwa','atakuwa','hii','hizi','zile','ile','hivi','vile',
                       'za','zake','zao','zenu','kwenye','katika','kwa','kwao','kwenu','kwetu','dhidi','kati','miongoni','katikati',
                       'wakati','kabla','baada','baadaye','nje','tena','mbali','halafu','hapa','pale','mara','mara','yoyote',
                       'wowote','chochote','vyovyote','yeyote','lolote','mwenye','mwenyewe','lenyewe','lenye','wote',
                       'lote','vyote','nyote','kila','zaidi','hapana','ndiyo','au','ama','ama','sio','siye','tu','budi','nyingi',
                       'nyingine','wengine','mwingine','zingine','lingine','kingine','chote','sasa','basi','bila','cha',
                       'chini','hapo','pale','huku','kule','humu','hivyo','hivyohivyo','vivyo','palepale','fauka','hiyo',
                       'hiyohiyo','zile','zilezile','hao','haohao','huku','hukuhuku','humuhumu','huko','hukohuko','huo',
                       'huohuo','hili','hilihili','ilikuwa','juu','karibu','kila','kima','kisha','kutoka','kwenda','kubwa',
                       'ndogo','kwamba','kuwa','la','lao','lo','mara','na','mdogo','mkubwa','ng’o','pia','aidha','vile',
                       'vilevile','kadhalika','halikadhalika','ni','sana','pamoja','pamoja','tafadhali','tena','wa',
                       'wake','wao','ya','yule','wale','zangu','nje','afanaleki','salale','oyee','yupi','ipi','lipi',
                       'ngapi','yetu','si','angali','wangali','loo','la','ohoo','barabara','oyee','ewaa','walahi',
                       'masalale','duu','toba','mh','kumbe','ala','ebo','haraka','pole','polepole','harakaharaka','hiyo',
                       'hivyo','vyovyote','atakuwa','itakuwa','mtakuwa','tutakuwa','labda','yumkini','haiyumkini',
                       'yapata','takribani','hususani','yawezekana','nani','juu','chini','ndani','baadhi',
                       'kuliko','vile','mwa','kwa','hasha','hivyo','moja','kisha','pili','kwanza','ili','je','jinsi',
                       'ila','a','b','c','d','e','f','g','h','ila','nini','hasa','huu','zako','mimi']
    stopwords_other = ['sifuri', 'moja', 'mbili', 'tatu', 'nne', 'tano', 'sita', 'saba', 'nane', 'tisa', 'kumi', 'may',
                        'pia', 'hela', 'kati ya', 'kando', 'bado', 'ndani', 'mr', 'bbc', 'picha', 'getty',
                        'de', 'en', 'caption', 'copyright', 'kitu','zero', 'one', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'nine', 'ten', 'may',
    ...
    more_stopwords = ['tag', 'wait', 'set', 'put', 'add', 'post', 'give', 'way', 'check', 'think',
                      ...
                      'quaranotine', 'day', 'time', 'week', 'amp', 'find', 'BTu','tag', 'subiri', 'weka', 'weka', 'ongeza', 'chapisha', 'toa', 'njia', 'angalia', 'fikiria',
                       'www', 'lazima', 'angalia', 'piga simu', 'dakika', 'com', 'kitu', 'mengi', 'kutokea',
                       'quaranotine', 'siku', 'saa', 'wiki', 'amp', 'pata', 'BTu']
    ...
    def __init__(self, convert_lower=True, use_spell_corrector=False, only_verbs_nouns=False):
        ...
        if self.use_spell_corrector:
            ...
            custom_unigram_dict_path = 'dataset/unigram_twitter_posts_dict.csv'
            custom_bigram_dict_path = 'dataset/bigram_twitter_posts_dict.csv'
